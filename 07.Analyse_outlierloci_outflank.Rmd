---
title: "Outlier loci detection with OutFlank"
output: github_document
---

## Setting up OutFLANK
See tutorial at https://adnguyen.github.io/2017_Ecological_Genomics/Tutorial/2017-04-03_Popgenomics5_outlier_annotations_DAPC_OutFLANK.html

First modify functions so it can read input file properly (https://github.com/whitlock/OutFLANK/issues/19)
```{r, eval=F, echo=T}
library(OutFLANK)
library(vcfR)
library(adegenet)
