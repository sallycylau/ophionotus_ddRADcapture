---
title: "Outlier loci detection with BayeScan"
output: github_document
---

## BayeScan between O. victoirae VS O. hexactis including O. victoriae from South Georgia
Generate input file with PGDSpider with samples defined by species (1. O. victoriae, 2. O. hexactis with O. victoriae from South Georgia defined as O. hexactis)  
<br>
...
Generate input file with PGDSpider with samples defined by environments (1. deep, 2. shelf, 3. islands)  
<br>
Run BayeScan in Terminal
```{bash, error=TRUE, results='hide'}
...
Generate input file with PGDSpider with samples defined by locations (1. ShagRocks, 2. SouthGeorgia, 3. BransfieldMouth, 4. HeardIsland)  
<br>
Run BayeScan in Terminal
```{bash, error=TRUE, results='hide'}
