...
maxiters = [3,5,10,15]
folds = [3,2,2,1]
upper = [30, 30, 30, 30, 30, 30, 30, 30, 30, 30]
...
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "strict_isolation", Models_2D.SI, rounds, 3, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, T")


# Split into two populations, migration between 2 pop.
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "IM", Models_2D.IM, rounds, 5, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, m12, m21, T")

# Split into two populations, secondary contact between 2 pop.
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "SC", Models_2D.SC, rounds, 6, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, m12, m21, T1, T2")

# Split into two populations, with asymmetric migration followed by isolation.
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "AM", Models_2D.AM, rounds, 6, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, m12, m21, T1, T2")

# Split with no migration, then size change with no migration.
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "SI_size", Models_2D.SI_size, rounds, 6, fs_folded=fs_folded,
...
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "SC_size", Models_2D.SC_size, rounds, 8, fs_folded=fs_folded,
...
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "AM_size", Models_2D.AM_size, rounds, 8, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1a, nu2a, nu1b, nu2b, m12, m21, T1, T2")
...
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "IM_size", Models_2D.IM_size, rounds, 8, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1a, nu2a, nu1b, nu2b, m12, m21, T1, T2")
...
Optimize_Functions.Optimize_Routine(fs, pts, prefix, "IM_size_asym", Models_2D.IM_size_asym, rounds, 10, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1a, nu2a, nu1b, nu2b, m12a, m21a, m12b, m21b, T1, T2")